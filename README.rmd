...
```
  ...
  title: "<p><img id=\"logo\" style=\"width: 20px;\" src=\"Noaa_logo.png\" /> R Workshop for AFSC RACE GAP </p>"    
...
Or directly view the vignettes here: 
 ...
 - [How to create the tables used in FEUS](https://emilymarkowitz-noaa.github.io/FishEconProdOutput/docs/articles/FEUS-tables.pdf)
 - [How to use this analysis for a collection of sub fisheries, such as in the Northeast US](https://emilymarkowitz-noaa.github.io/FishEconProdOutput/docs/articles/NEFSC-Fishery.pdf)
