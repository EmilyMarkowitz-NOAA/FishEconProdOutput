...
## Download Package for Output Portion of Function
...
We use the *QuantityMethodOutput_Category* function to calculate everything we did above at category level. 
...
# print(QuantityMethodOutput_Category)
```
...
tempS<-QuantityMethodOutput_Category(temp, ii, baseyr, maxyr, minyr, 
                         pctmiss = pctmiss, 
...
We use the *PriceMethodOutput_Category* function to calculate everything we did above at category level. 
...
# print(PriceMethodOutput_Category)
```
...
tempS<-PriceMethodOutput_Category(temp, ii, baseyr, maxyr, minyr, 
                         pctmiss = pctmiss, 
                         warnings.list = warnings.list)
temp<-cbind.data.frame(temp, tempS[[1]])
warnings.list<-tempS[[2]]
...
#### C. Run the function
```{r, echo = echoTF(TRUE, code), warning = FALSE}
temp00<-PriceMethodOutput(temp = orgional.data, baseyr, pctmiss)
temp<-temp00[[1]]
warnings.list0<-temp00[[2]]
figures.list0<-temp00[[3]]
```
